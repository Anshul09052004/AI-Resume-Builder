  ...
  return (
    <div className="max-w-5xl mx-auto bg-white text-gray-900">
      <div className="grid grid-cols-3 min-h-screen">
        ...
        {/* Left Sidebar */}
        <aside className="col-span-1 border-r border-zinc-300 p-6 flex flex-col items-center">
          {/* Image */}
          ...
          <section className="mb-8 w-full">
            <h2 className="text-sm font-semibold tracking-widest text-black mb-3">
              CONTACT
            </h2>
        ...
        {/* Right Content */}
        <main className="col-span-2 p-8 pt-10">
          {/* Name + Title */}
          <div className="mb-8">
            <h1 className="text-4xl font-bold text-black tracking-widest">
