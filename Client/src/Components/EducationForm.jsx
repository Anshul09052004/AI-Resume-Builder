    ...
    return (
        <div className="bg-gray-50 rounded-2xl shadow-lg p-6 space-y-6">
            ...
            {data.map((education, index) => (
                <div
                    key={index}
                    className="border border-gray-300 rounded-xl p-5 space-y-4 bg-white shadow-sm hover:shadow-md transition-all"
                >
                    {/* Title + Remove */}
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                        ...
                        <input
                            ...
                            className="w-full p-2.5 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-400 capitalize"
                        />
