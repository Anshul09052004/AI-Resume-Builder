                ...
                <div className="absolute mt-2 w-full bg-white rounded-lg shadow-lg overflow-hidden z-50 border border-gray-200">
                    {colors.map((color) => (
                        <div
                            ...
                            className={`flex items-center justify-between p-3 cursor-pointer hover:bg-gray-100 transition-all ${selectedColor === color.value ? "bg-green-600 text-white" : "bg-white text-gray-800"
                                }`}
                        >
